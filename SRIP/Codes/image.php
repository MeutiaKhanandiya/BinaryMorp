...
<html lang="en-US">
 ...
 <li class="nav-item dropdown">
	...
	<body>
    <h1>Morphological Operations with Pixels</h1>
    <div class="responsive">
        <div class="gallery">
            <a href="Operation/operation1.php"><img src="Images/1.png" width="300" height="200"></a>
            <div class="des">3x3 Pixels</div>
        </div>
    </div>

    <div class="responsive">
        <div class="gallery">
            <a href="Operation/operation2.php"><img src="Images/2.png" width="300" height="200"></a>
            <div class="des">5x5 Pixels</div>
        </div>
    </div>

    <div class="responsive">
        <div class="gallery">
            <a href="Operation/operation3.php"><img src="Images/3.png" width="300" height="200"></a>
            <div class="des">7x7 Pixels</div>
        </div>
    </div>
</body>	
