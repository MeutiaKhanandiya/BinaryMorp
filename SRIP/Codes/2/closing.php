...
<div class="container-fluid">
    ...
    <div class="row mt-4">
        ...
        <div class="item col-sm-6 col-md-4 mb-3">
            <a href="img/Closing_ellipse.png" class="fancybox" data-fancybox="gallery1">
                <img src="img/Closing_ellipse.png" width="100%" height="100%">
            </a>
        </div>

        <div class="item col-sm-6 col-md-4 mb-3">
            <a href="img/Closing_rectangle.png" class="fancybox" data-fancybox="gallery1">
                <img src="img/Closing_rectangle.png" width="100%" height="100%">
            </a>
        </div>

        <div class="item col-sm-6 col-md-4 mb-3">
            <a href="img/Closing_cross.png" class="fancybox" data-fancybox="gallery1">
                <img src="img/Closing_cross.png" width="100%" height="100%">
            </a>
        </div>
