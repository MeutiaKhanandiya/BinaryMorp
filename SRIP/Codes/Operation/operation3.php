...
<html lang="en-US">
 ...
 <li class="nav-item dropdown">
  ...
  <body>
        <div class="container">
        <a href="../3/dilation.php">
          <button class="btn btn1">Dilation</button>
        </a>
        <a href="../3/erosion.php">
          <button class="btn btn2">Erosion</button>
        </a>
        <a href="../3/opening.php">
          <button class="btn btn3">Opening</button>
        </a>
        <a href="../3/closing.php">
          <button class="btn btn4">Closing</button>
      </a>
</div>
  </body>
